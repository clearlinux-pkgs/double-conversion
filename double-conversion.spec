...
Source0  : https://github.com/google/double-conversion/archive/v3.3.1/double-conversion-3.3.1.tar.gz
...
%prep
%setup -q -n double-conversion-3.3.1
cd %{_builddir}/double-conversion-3.3.1
pushd ..
cp -a double-conversion-3.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739545730
mkdir -p clr-build
pushd clr-build
...
export GOAMD64=v2
%cmake .. -DBUILD_SHARED_LIBS:BOOL=ON -DINSTALL_LIB_DIR=/usr/lib64  -G 'Unix Makefiles'
make  %{?_smp_mflags}
popd
pushd ../buildavx2/
