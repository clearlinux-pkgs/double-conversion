...
Source0  : https://github.com/google/double-conversion/archive/v3.2.0/double-conversion-3.2.0.tar.gz
...
%prep
%setup -q -n double-conversion-3.2.0
cd %{_builddir}/double-conversion-3.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656020859
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/double-conversion-3.2.0/COPYING %{buildroot}/usr/share/package-licenses/double-conversion/8d434c9c1704b544a8b0652efbc323380b67f9bc
cp %{_builddir}/double-conversion-3.2.0/LICENSE %{buildroot}/usr/share/package-licenses/double-conversion/8d434c9c1704b544a8b0652efbc323380b67f9bc
pushd clr-build-avx2
%make_install_v3  || :
popd
pushd clr-build
